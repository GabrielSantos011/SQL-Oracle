--CHAMANDO UMA PROCEDURE DENTRO DE OUTRA
...
BEGIN
--COMO NOSSO PARAMETRO p_CNPJ É IN NÃO PODEMOS ALTERAR ELE
--PORTANTO CRIAMOS UMA VARIALVEL DE TRABALHO PARA PODER ALTERAR
--CONSEQUENTEMENTE FORMATAMOS E INCLUIREMOS ELA NO INSERT
   formata_cnpj(v_CNPJ);
