--há exceções não cadastradas
--para este caso não encontraremos o nome dela na documentação
--do oracle
--como faremos então?
--criamos uma variavel do tipo exception e vinculamos ela
--ao código dado na exception
--após isso podemos trata-la no bloco de exceções
