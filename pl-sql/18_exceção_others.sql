--tratando erros "por meio de um else"
--há diversos erros em uma aplicação
--não temos como tratar todos
--portando colocamos um 
--WHEN others THEN
--pois assim qlqr tipo de erro entra
--é importante que esse cara sej o último
--pois a partir do momento que entrou dele ele não fará mais nenhum
